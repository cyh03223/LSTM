...
# Split into train/val/test （8:1:1 ratio）
...
# Use full‐batch training as before
...
rnn = Sequential([
    LSTM(units, return_sequences=True, input_shape=(None, input_dim))
])
output_layer = Dense(dim_y)
...
def train_step(x_batch, y_batch):
    ...
    train_vars = rnn.trainable_variables + output_layer.trainable_variables
